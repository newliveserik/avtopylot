...
public class MainActivity extends AppCompatActivity {
    ...
    private void showLoginDialog() {
        ...
        dialog.setMessage("Пожалуйста введи email для логина");

        LayoutInflater inflaiter = LayoutInflater.from(this);
        View login_layout = inflaiter.inflate(R.layout.layout_login,null);
    ...
    private void showRegisterDialog(){
        ...
        dialog.setMessage("Пожалуйста введи email для регистрации");

        LayoutInflater inflaiter = LayoutInflater.from(this);
        View register_layout = inflaiter.inflate(R.layout.layout_register,null);
